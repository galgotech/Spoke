    ...
    render(props) {
      return (
        <OnboardingDialog {...props} disablePrev disableSkip>
          ...
          <h1>Great Job!</h1>
          <p>
            Great job! You&#39;ve touched all the basics and published a scene! To get started on your own scene
            checkout your projects page. Or click finish to continue working on this scene.
          </p>
